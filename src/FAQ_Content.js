const FAQ_Content = [
    {
        id: "q1",
        p: "Como sei qual medicamento é seguro ou não?",
        r: "No resultado da pesquisa, os medicamentos sem as substâncias alergênicas aparecerão em verde, enquanto os que as contêm aparecerão em vermelho com a substância alergênica presente no medicamento. Os resultados em amarelo indicam que não foi encontrado, na base de dados, o princípio ativo do medicamento."
    },
    {
        id: "q2",
        p: "O resultado apareceu verde. Isso significa que é seguro e não terei reação alérgica?",
        r: "Não, apenas indica que a substância que foi selecionada no filtro não está presente no medicamento. Um farmacêutico ou médico deve ser consultado para a sua segurança."
    },
    {
        id: "q3",
